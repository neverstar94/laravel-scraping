...
userdata_path = "C:\\Users\\Administrator\\AppData\\Local\\Google\\Chrome\\User Data\\Profile7"
...
def main():
	...
	mycursor.execute("SELECT * FROM siteinfos WHERE url = 'Target'")
...
def test_chrome(userid,useremail,userpassword):
	...
	signin = driver.find_element(By.CSS_SELECTOR, ".h-margin-r-x3")
	signin.click()
	time.sleep(5)
	signin_1 = driver.find_element(By.ID, "listaccountNav-signIn")
	signin_1.click()
	time.sleep(10)
